...
export const CONFIG = {
  ...
  forest: {
    ...
    treeModels: [
      {
        ...
        url: '/models/cypress-asymmetric-a.glb',
        height: 6.2,
        count: 68,
        minScale: 0.7,
        maxScale: 1.18,
      ...
      },
      {
        ...
        url: '/models/cypress-asymmetric-b.glb',
        height: 6.2,
        count: 68,
        minScale: 0.68,
        maxScale: 1.15,
    ...
    /** 길가·풀숲 덩굴 — flower-vine1 + vine 교차, flower-vine 추가 산포 */
    flowerModels: [
      {
        id: 'flower-vine1',
      ...
      },
      {
        ...
        material: {
          ...
          roughness: 1,
          randomFoliage: true,
          foliagePalette: ['#8da94a', '#7a9936', '#848e4b', '#707830'],
        },
      },
      {
        id: 'flower-vine',
        url: '/models/flower-vine-optimized.glb',
        height: 0.88,
        count: 100,
        minScale: 0.78,
        maxScale: 1.06,
    ...
    /** 나무 캐노피 간격 — 클수록 더 흩어짐 */
    canopyPadding: 2.35,
    canopyRadiusScale: 0.88,
    treePathPad: 2.8,
    /** 꽃 덩굴 공통 팔레트 — UV 꽃 정점만 인스턴스 색 */
    flowerPalette: ['#ffa45c', '#fff591', '#fcb1b1'],
  },
